...
#include <jni.h>
/* Header for class edu_ustc_nodb_GPUGraphX_algorithm_shm_SSSP_GPUNativeShm */

#ifndef _Included_edu_ustc_nodb_GPUGraphX_algorithm_shm_SSSP_GPUNativeShm
#define _Included_edu_ustc_nodb_GPUGraphX_algorithm_shm_SSSP_GPUNativeShm
#ifdef __cplusplus
extern "C" {
#endif
/*
 * Class:     edu_ustc_nodb_GPUGraphX_algorithm_shm_SSSP_GPUNativeShm
