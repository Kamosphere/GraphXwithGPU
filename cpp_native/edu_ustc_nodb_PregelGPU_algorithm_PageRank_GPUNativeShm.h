...
#include <jni.h>
/* Header for class edu_ustc_nodb_PregelGPU_algorithm_PageRank_GPUNativeShm */

#ifndef _Included_edu_ustc_nodb_PregelGPU_algorithm_PageRank_GPUNativeShm
#define _Included_edu_ustc_nodb_PregelGPU_algorithm_PageRank_GPUNativeShm
#ifdef __cplusplus
extern "C" {
#endif
/*
 * Class:     edu_ustc_nodb_PregelGPU_algorithm_PageRank_GPUNativeShm
