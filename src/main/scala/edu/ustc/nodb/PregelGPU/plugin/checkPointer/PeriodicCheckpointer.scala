package edu.ustc.nodb.PregelGPU.plugin.checkPointer
...
/**
  ...
  */
abstract class PeriodicCheckpointer[T](val checkpointInterval: Int,
...
object PeriodicCheckpointer extends Logging {
